...
| <a name="input_inbound_cidrs"></a> [inbound\_cidrs](#input\_inbound\_cidrs) | Comma-separated list of CIDR blocks allowed to access the public subnet | `string` | `"0.0.0.0/0"` | no |
